...
CharacterDeleteKeyCommand::CharacterDeleteKeyCommand(TextEditor* textEditor) {
	this->textEditor = textEditor;
	this->isNew = true;
	this->isMacro = false;
}

CharacterDeleteKeyCommand::CharacterDeleteKeyCommand(TextEditor* textEditor, Long row, Long column, char* character, Long longestRow, Long hSMax){
	this->textEditor = textEditor;
	this->isNew = false;
	this->isMacro = false;
	this->row = row;
...
CharacterDeleteKeyCommand::~CharacterDeleteKeyCommand() {

}

void CharacterDeleteKeyCommand::Execute() {
	Glyph* character;
	Command* command;
	...
	if (this->isNew == true) {
		...
		command = new CharacterDeleteKeyCommand(this->textEditor, this->row, this->textEditor->current->GetCurrent(), this->character, this->longestRow, this->hSMax);
...
void CharacterDeleteKeyCommand::Unexecute() {
	Glyph* character;
	...
	this->textEditor->current->Add(this->column, character, this->textEditor->characterMetrics);
